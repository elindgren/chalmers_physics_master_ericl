...
#define N1 2 		// the number of atoms that will be independently treated in vibration analysis (condition: N1<=N0, N0%N1==0)
#define LCON 2.752	// lattice constant (A)
#define NK 24 		// the number of sampling points in Brillouin zone
